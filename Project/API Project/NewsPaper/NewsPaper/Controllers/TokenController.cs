...
namespace NewsPaper.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        private readonly NewsDbContext _con;

        // Static admin credentials
        private const string AdminUsername = "admin";
        private const string AdminPassword = "admin123";

        public TokenController(IConfiguration configuration, NewsDbContext con)
        {
        ...
        public string GenerateToken(User user)
        {
            ...
            else
            {
                ...
                string? requiredRole = user.Roles; // Adjust the required role as needed
                ...
                if (ValidateUser(user.UserEmail, user.Password, requiredRole))
                {
                    ...
                    var claims = new List<Claim>
                  {
                      ...
                      new Claim(ClaimTypes.Role, user.Roles) // Admin role
        ...
        private bool ValidateUser(string email, string password, string requiredRole)
        {
            ...
            return user != null && user.Roles == requiredRole;
        }
    }
}
